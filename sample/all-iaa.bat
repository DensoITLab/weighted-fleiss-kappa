...
java -Dfile.encoding=UTF-8 -cp %CLASSPATH% jp.co.d_itlab.dbdc.tool.IAATool -s %COMMAND% -dic %DIC_DIR% -c %CATEGORY% -a %ANNOTATORS% -i %INPUT_DIR% -l %LOCALE%